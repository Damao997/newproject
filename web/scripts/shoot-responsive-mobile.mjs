// 05 / responsive-mobile: 截 React (/_design/antd-style) + Design (pages/responsive-mobile.html) 全页
// 目标：React desktop bytes >= Design desktop bytes
// 用法：node scripts/shoot-responsive-mobile.mjs
...
async function waitForReactReady(page) {
  ...
  await page.waitForSelector('text=Responsive', { timeout: 30000 }).catch(() => {})
...
async function main() {
...

  {
    ...
    for (const vp of [{ name: 'desktop', width: 1440, height: 900 }, { name: 'mobile', width: 390, height: 844 }]) {
      ...
      await page.goto(`${DESIGN_BASE}/responsive-mobile.html`, { waitUntil: 'networkidle', timeout: 30000 }).catch(() => {})
  ...
  console.log(`===== 05 Responsive & Mobile / ${SLUG} =====`)
