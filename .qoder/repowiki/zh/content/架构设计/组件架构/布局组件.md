...
## 更新摘要
**所做更改**
- 新增侧边栏导航组件（sidebar.tsx）的详细文档说明
- 更新主布局结构重新设计的相关章节
- 改进头部组件的功能描述和配置选项
- 新增导航项目管理系统（nav-items.ts）的详细说明
- 增强路由组织与布局集成的架构分析
- 更新组件依赖关系图和架构图以反映新的布局结构
...
**更新** 本次更新重点反映了主布局结构的重新设计，新增了完整的侧边栏导航组件系统、改进的头部组件功能、全新的导航项目管理系统，以及增强的路由组织结构。
...
**更新** 新增了 sidebar 侧边栏导航组件和 nav-items 导航项目管理系统的详细说明。
...
**更新** 主布局现在集成了侧边栏组件，提供了更完整的布局解决方案。
...
**新增** 这是全新引入的侧边栏导航组件，提供了完整的导航管理能力。
