...
## 引言
本规范面向pj3前端工程，目标是统一代码风格、组件设计、协作流程与调试排错方法，提升可维护性与交付质量。内容覆盖：
...
- [web/src/index.css:1-200](file://web/src/index.css#L1-L200)
...
## 架构总览
前端采用Vite + React + TypeScript构建，TailwindCSS进行样式编排，Oxlint进行静态检查，Vitest进行单元测试。
...
章节来源
- [web/src/test/setup.ts:1-200](file://web/src/test/setup.ts#L1-L200)
- [web/vitest.config.ts:1-200](file://web/vitest.config.ts#L1-L200)
- [docs/references/testing.md:1-200](file://docs/references/testing.md#L1-L200)

## 结论
本规范从代码风格、组件设计、协作流程到调试排错形成闭环，配合工程化工具链与文档体系，帮助团队高效协作与持续交付。建议在新需求与重构中持续迭代完善。
...
- [web/vite.config.ts:1-200](file://web/vite.config.ts#L1-L200)
- [web/tailwind.config.js:1-200](file://web/tailwind.config.js#L1-L200)
- [web/postcss.config.js:1-200](file://web/postcss.config.js#L1-L200)
...
章节来源
- [web/README.md:1-200](file://web/README.md#L1-L200)
