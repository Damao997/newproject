...
> 归档日期：**2026-07-20** | v3 迁移日期：**2026-07-21** | 归类整合日期：**2026-08-05**
...
- `docs/references/` — 引用：模块化快速参考（12 篇）
- `docs/plans/` — 方案：权威深度规范（6 篇）
- `docs/data-templates/` — 数据模版：示例 Excel 数据
- `docs/archive/`（本目录）— 历史文档：已废止的旧版本文档
- `docs/superpowers/` — 高级功能规划与规格说明（plans/ + specs/）

v2 毛玻璃 UI 设计规范（原存放于 `specs/`）已废止并移入本归档目录。
...
| 13 | `全面代码审查报告-2026-07-30.md` | **2026-08-05 归类整合归档**——全栈代码审查，部分结论已被差异对齐报告复核更正 |
| 14 | `前端全面审查报告-2026-07-27.md` | **2026-08-05 归类整合归档**——前端专项审查快照 |
| 15 | `文档与代码差异对齐报告-2026-07-30.md` | **2026-08-05 归类整合归档**——审查复核与最新文档-代码一致性结论（历史参考） |
| 16 | `项目交接文档-2026-07-26.md` | **2026-08-05 归类整合归档**——时点快照，部分内容已过时 |
